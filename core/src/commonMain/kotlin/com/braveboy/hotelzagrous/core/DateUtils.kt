...
object DateUtils {
    ...
    // This is a simple implementation. In a real app, you'd use a better way to handle Jalali date arithmetic.
    // For now, if we have checkIn and checkOut as Gregorian millis, it's easier.
    // But since they are stored as Jalali strings, we'll need to parse or store both.
}
